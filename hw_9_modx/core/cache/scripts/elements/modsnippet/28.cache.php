<?php  return '$result=$modx->query(\'SELECT `id`, `pagetitle`, `content`, `publishedon`, `uri` FROM `modx_site_content`WHERE `parent`!=0 AND `isfolder`=0 ORDER BY `publishedon` DESC\');
$return=\'\';
