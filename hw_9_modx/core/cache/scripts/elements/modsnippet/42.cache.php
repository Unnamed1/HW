<?php  return '$result=$modx->query(\'SELECT `id`, `pagetitle`, `content`, `publishedon`, `uri` FROM `modx_site_content` WHERE FROM_UNIXTIME(`publishedon`, \\\'%m %Y\\\')=\\\'\'.$_GET[\'arc_month\'].\' \'.$_GET[\'arc_year\'].\'\\\' AND `parent`!=0 AND `isfolder`=0 ORDER BY `publishedon` DESC\')->fetchAll(PDO::FETCH_ASSOC);
$return=\'\';
